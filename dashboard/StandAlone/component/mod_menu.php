  ...
  <div class="scrollbar-inner">
    ...
    <div class="sidenav-header d-flex align-items-center">
      ...
      <a class="navbar-brand" href="index.php">
          <img src="./assets/img/brand/bot.png" class="navbar-brand-img" alt="Home">
      </a>
      <div class="ml-auto">
        <!-- Sidenav toggler -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="broadcast.php">
              ...
              <span class="nav-link-text">ออกประกาศ</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="document.php">
              <i class="ni ni-circle-08 text-pink"></i>
              <span class="nav-link-text">ติดตามเอกสาร</span>
            </a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="calendar.php">
              ...
              <span class="nav-link-text">ปฏิทินงาน</span>
            </a>
          </li>
          <li class="nav-item">
